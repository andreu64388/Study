...
using ContactRepository.Entity;
...
public class TelephoneTelephoneRepository:ITelephoneRepository<ContactEntity>
{
    private readonly AppDbContext _appDbContext;

    public TelephoneTelephoneRepository(AppDbContext appDbContext)
    {
