...
VALUES
	...
	-- Вставьте данные в таблицу Services
...
-- Пример вставки данных в таблицу Order_Services (связь между заказами и услугами)
INSERT INTO Order_Services (Order_Service_id, Order_id, Service_id)
VALUES
    (1, 1, 1),  -- Заказ 1 связан с услугой 1
    (2, 1, 2),  -- Заказ 1 также связан с услугой 2
    (3, 2, 1);  -- Заказ 2 связан с услугой 1
