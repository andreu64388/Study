...
spool "MIGRATION_TEST_&filename..log"

-- Password file execution
@passworddefinition.sql

PROMPT Dropping Role ROLE_MIGRATION_TEST ...
DROP ROLE ROLE_MIGRATION_TEST ;
PROMPT Creating Role ROLE_MIGRATION_TEST ...
CREATE ROLE ROLE_MIGRATION_TEST ;
...
GRANT ALL ON utils TO ROLE_MIGRATION_TEST;
...
set define off
-- DROP TABLE migrate_users CASCADE CONSTRAINTS;


PROMPT Creating Table migrate_users ...
...
GRANT ALL ON migrate_users TO ROLE_MIGRATION_TEST;
