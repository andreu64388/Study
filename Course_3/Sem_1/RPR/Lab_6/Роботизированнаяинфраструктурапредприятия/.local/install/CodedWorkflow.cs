...
namespace Роботизированнаяинфраструктурапредприятия
{
...
namespace Роботизированнаяинфраструктурапредприятия.ObjectRepository
{
...
namespace Роботизированнаяинфраструктурапредприятия._Implementation
{
