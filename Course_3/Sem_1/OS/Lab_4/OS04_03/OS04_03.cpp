...
int main()
{
	...
	for (short i = 1; i <= 100; ++i)
	{
		switch (i)
		{
		case 10: SuspendThread(handleClild_T1); break;
		case 15: ResumeThread(handleClild_T1);  break;
		case 20: SuspendThread(handleClild_T2); break;
		case 25: ResumeThread(handleClild_T2); break;
		}
