...
// ../../node_modules/.pnpm/@prisma+engines-version@5.10.0-34.5a9203d0590c951969e85a7d07215503f4672eb9/node_modules/@prisma/engines-version/package.json
var require_package = __commonJS({
  "../../node_modules/.pnpm/@prisma+engines-version@5.10.0-34.5a9203d0590c951969e85a7d07215503f4672eb9/node_modules/@prisma/engines-version/package.json"(exports2, module2) {
    module2.exports = {
...
// ../../node_modules/.pnpm/@prisma+engines-version@5.10.0-34.5a9203d0590c951969e85a7d07215503f4672eb9/node_modules/@prisma/engines-version/index.js
var require_engines_version = __commonJS({
  "../../node_modules/.pnpm/@prisma+engines-version@5.10.0-34.5a9203d0590c951969e85a7d07215503f4672eb9/node_modules/@prisma/engines-version/index.js"(exports2) {
    "use strict";
...
var require_read_pkg_up = __commonJS({
  "../../node_modules/.pnpm/read-pkg-up@7.0.1/node_modules/read-pkg-up/index.js"(exports2, module2) {
    ...
    module2.exports = async (options) => {
      const filePath = await findUp3("package.json", options);
      if (!filePath) {
        return;
      }
      return {
    ...
    module2.exports.sync = (options) => {
      const filePath = findUp3.sync("package.json", options);
      if (!filePath) {
        return;
      }
      return {
...
var require_common_path_prefix = __commonJS({
  "../../node_modules/.pnpm/common-path-prefix@3.0.0/node_modules/common-path-prefix/index.js"(exports2, module2) {
    ...
    module2.exports = function commonPathPrefix2(paths2, sep = determineSeparator(paths2)) {
      ...
      for (const path7 of remaining) {
        const compare = path7.split(sep);
...
var require_env_paths = __commonJS({
  "../../node_modules/.pnpm/env-paths@2.2.1/node_modules/env-paths/index.js"(exports2, module2) {
    ...
    var windows = (name) => {
      const appData = env2.APPDATA || path7.join(homedir, "AppData", "Roaming");
      const localAppData = env2.LOCALAPPDATA || path7.join(homedir, "AppData", "Local");
      return {
...
var require_locate_path3 = __commonJS({
  "../../node_modules/.pnpm/locate-path@3.0.0/node_modules/locate-path/index.js"(exports2, module2) {
    ...
    var pLocate2 = require_p_locate3();
    module2.exports = (iterable, options) => {
      options = Object.assign({
        cwd: process.cwd()
      }, options);
      return pLocate2(iterable, (el) => pathExists2(path7.resolve(options.cwd, el)), options);
    };
    module2.exports.sync = (iterable, options) => {
      ...
      for (const el of iterable) {
        if (pathExists2.sync(path7.resolve(options.cwd, el))) {
          return el;
        }
      }
    };
...
var require_find_up3 = __commonJS({
  "../../node_modules/.pnpm/find-up@3.0.0/node_modules/find-up/index.js"(exports2, module2) {
    "use strict";
    var path7 = require("path");
    var locatePath2 = require_locate_path3();
...
function getSchemaPathFromPackageJsonSync(cwd2) {
  const pkgJson = import_read_pkg_up.default.sync({ cwd: cwd2 });
